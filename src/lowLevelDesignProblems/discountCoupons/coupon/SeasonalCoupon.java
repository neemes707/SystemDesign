...
public class SeasonalCoupon implements Coupon{
    private Coupon nextCoupon;
    private DiscountStrategy discountStrategy;

    public SeasonalCoupon(Coupon nextCoupon, DiscountStrategy discountStrategy) {
    ...
    public void printInfo() {
        System.out.println("Seasonal Coupon");
    }
